...
from tests.stubs import StubTomeRepository, make_stub_ingestor
...
async def test_concurrent_ingest_duplicates() -> None:
    """Two concurrent ingests of similar content should both succeed, though they might create duplicates."""
    ingestor, repo, _ = make_stub_ingestor()
